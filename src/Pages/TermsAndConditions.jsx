  ...
  return (
    <>
      <div className="w-full aspect-[16/13] sm:aspect-[16/8] lg:aspect-[16/6] overflow-hidden relative">
        ...
        />
        <h4 className="absolute z-[3] top-1/2 left-1/2 text-transparent bg-clip-text bg-white/80 font-bold text-6xl drop-shadow-[1px_1px_1px_black] -translate-y-1/2 -translate-x-1/2 sm:-translate-y-0 sm:-translate-x-0">
      ...
      <div className="bg-[url('/about-us-our-aproach-bg.jpg')]">
        <div className="md:w-4/5 mx-auto relative ">
          <img
            src="/butterfly-flying-animation.gif"
            alt=""
            className="fixed top-[80%] z-[2] butterfly"
            width="200px"
            height="200px"
          />
          <div className="custom-container flex flex-col gap-4 py-6 md:py-8 lg:py-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="pl-4 text-black/50 flex flex-col gap-4">
                ...
                <li>
                  ...
                  <Link to="/" className=""></Link>https://vardaanfarms.com/
                </li>
                <li>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                <h3 className="text-lg font-semibold text-black/70">Waiver</h3>
                <p className="text-black/50">
