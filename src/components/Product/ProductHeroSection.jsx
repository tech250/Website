...
const ProductHeroSection = ({ data }) => {
  ...
  return (
    <div className={`relative`}>
      <div className="custom-container flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 py-6 md:py-8 lg:py-12 items-center justify-between relative">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4 self-center">
          ...
          <h1
            className={`text-2xl md:text-3xl lg:text-4xl font-semibold w-fit text-transparent bg-clip-text drop-shadow-[1px_1px_1px_black] bg-black/50`}
          >
            {data.heading}
          </h1>
          ...
          <div className="pt-4">
            ...
            <Link
              to="/contact-us"
              className="text-black px-4 py-3 border border-l-0"
            >
              Lets Connect
            </Link>
          </div>
      ...
      <img src="/footer-img.jpeg" alt="" className="w-[150px] lg:w-[250px] absolute right-0 bottom-0 z-[-1]"/>
    </div>
  );
};
